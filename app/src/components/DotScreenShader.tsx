...
const DotMaterial = shaderMaterial(
  {
    ...
    dotColor: new THREE.Color('#e1e1e1'),
...
function Scene() {
  ...
  // Light mode colors for dark footer background
  const themeColors = {
    dotColor: '#FFFFFF', // bright white dots
    bgColor: '#0F172A', // midnight color
    dotOpacity: 0.4 // higher opacity for better visibility
  }
  ...
  }, [dotMaterial, themeColors, size.width, size.height, viewport.dpr, rotation, gridSize, trail])
